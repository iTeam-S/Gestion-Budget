                ...
                <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                    <div class="card card-plain mt-8">
                        <div class="card-header pb-0 text-left bg-transparent">
                            <h3 class="teal_color">{{ __('COMPTA - ITEAMS') }}</h3>
                        ...
                        <div class="card-body">
                            <form wire:submit.prevent="login" action="#" method="POST" role="form text-left">
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('Mot de passe') <div class="text-danger">{{ $message }}</div> @enderror
                                </div>
                        ...
                        <div class="card-footer text-center pt-0 px-lg-2 px-1">
                            <!-- <small class="text-muted">{{ __('Mot de passe oublier? Reset you password') }} <a
                ...
                <div class="col-md-6">
                    <div class="oblique position-absolute top-0 h-100 d-md-block d-none me-n8">
                        <div class="oblique-image bg-cover position-absolute fixed-top ms-auto h-100 z-index-0 ms-n6"
                            style="background-image:url('../assets/img/curved-images/teal.jpg')"></div>
                    </div>
                </div>
            </div>
        </div>
