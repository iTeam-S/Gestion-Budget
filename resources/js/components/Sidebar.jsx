    ...
    return (
        <React.Fragment>
            <aside className="flex-none">
                <div className="border rounded w-[200px] h-[200px] m-4">
                        <div>
                        ...
                        <div>
                        <Link to="journals" className="flex flex-row">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <Link to="ecritures" className="flex flex-row">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z" />
                            </svg>
                            <span className="nav-link-text ms-1">Ecritures</span>
                        </Link>
                        <Link to="comptes" className="flex flex-row">
                        ...
                        <Link to="nouvelles" className="flex flex-row">
                            <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
