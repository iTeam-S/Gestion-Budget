...
function ErrorSVG(props){
    ...
    /* selection des composants à animer */
    // by reference
    ...
    // by selector
    const errorSVGContainer = useRef();
    const containerSelector = gsap.utils.selector(errorSVGContainer); 
    const stars= useRef();
    const starsSelector = gsap.utils.selector(stars);

    useEffect(() => {
        gsap.set(containerSelector("svg"), { visibility: "visible" });
        ...
        gsap.to(starsSelector("#starsBig g"), {
        ...
        gsap.fromTo(starsSelector("#starsSmall g"),
            { scale: 0, transformOrigin: "50% 50%" },
            { scale: 1, transformOrigin: "50% 50%", yoyo: true, repeat: -1, stagger: 0.1 }
        );

        gsap.to(starsSelector("#circlesSmall circle"), {
            y: -4,
            yoyo: true,
            duration: 1,
            ease: "sine.inOut",
        ...
        gsap.to(starsSelector("#circlesBig circle"), {
            y: -2,
            yoyo: true,
            duration: 1,
            ease: "sine.inOut",
    ...
    return(
        <div className="md:grid md:grid-cols-2 items-center h-screen">
            <div className="w-screen md:w-[calc(100vw/2)]">
                ...
                <g>
                    ...
                    <g ref={planet}>
                        ...
                        <circle ref={craterBig} fill="none" stroke="#0E0620" strokeWidth="3" strokeMiterlimit="10" cx="548.891"
                            cy="62.319" r="13.074" 
                        />

                        <circle ref={craterSmall} fill="none" stroke="#0E0620" strokeWidth="3" strokeMiterlimit="10" cx="591.743"
                            cy="158.918" r="7.989" 
                        />
                    ...
                    <g ref={spaceMan} clipPath="url(cordClip)">
                    ...
                    <g id="head">
                        ...
                        <path ref={headStripe}  fill="none" stroke="#0E0620" strokeWidth="3" strokeLinecap="round"
                        strokeLinejoin="round" strokeMiterlimit="10" d="
                        ...
                        <polygon ref={glassShine} fill="none" stroke="#0E0620" strokeWidth="3" strokeMiterlimit="10" points="
        ...
        <div className="w-screen my-8 md:my-0 md:w-[calc(100vw/2)]">
            <p className="text-center">page introuvable</p>
        </div>
        </div>
    )
  }
